...
export const OFFICIAL_URL = 'https://nice-chat.syndataworks.cn/';
export const OFFICIAL_PREVIEW_URL = 'https://nice-chat.syndataworks.cn/';
export const OFFICIAL_SITE = 'https://www.syndataworks.cn/';
...
export const EMAIL_SUPPORT = 'laihongchang@syndataworks.com';
export const EMAIL_BUSINESS = 'laihongchang@syndataworks.com';
